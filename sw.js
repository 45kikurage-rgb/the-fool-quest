importScripts('./portal-screenshots.js?v=20260921-tools-usage-v3-v3');
const CACHE="the-fool-quest-20260921-tools-usage-v3";
const SHARE_CACHE='the-fool-quest-share-v1';
const ASSETS=['./portal-screenshots.js?v=20260921-tools-usage-v3-v3','./','./index.html','./style.css?v=20260921-tools-usage-v3-v3','./app.js?v=20260921-tools-usage-v3-v3','./fonts/Corporate-Logo-Rounded-Bold-ver3.woff2','./manifest.webmanifest?v=20260914-white-splash','./title-logo.png','./icon-any-192.png?v=20260914-white-splash','./icon-any.png?v=20260914-white-splash','./icon-maskable-192.png?v=20260914-white-splash','./icon-maskable.png?v=20260914-white-splash'];
